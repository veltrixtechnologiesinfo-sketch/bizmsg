              ...
              {links.map((l, i) => (
                ...
                >
                  <a
                    href={l.href}
                    onClick={(e) => handleNav(e, l.href)}
                    className="block rounded-lg px-3 py-3 text-base font-medium text-slate-700 transition-colors hover:bg-slate-100 hover:text-navy active:bg-slate-100"
                  >
                    {l.label}
                  </a>
                </motion.li>
